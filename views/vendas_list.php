                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="data" datepicker="date" class="form-control"
                                                       id="dropdown-appended">
                                                <div class="input-group-btn dropdown" data-dropdown="">
                                                    <select class="form-control 1x" name="usuario" style="width: 150px">
                                                        <option value="0">Qualquer Usuario</option>
                                                        <?php
                                                        $query = $us::listar();
                                                        while ($dado = $query->fetch(PDO::FETCH_OBJ)) {
                                                            echo '<option value="' . $dado->id . '">' . $dado->username . '</option>';
                                                        } ?>
                                                    </select>

                                                </div>
                                                <button class="form-control btn btn-primary" style="width: 40px"><span
                                    ...
                                    <div class=" pull-right" style="background: #F00">
                                        <div class="form-group">
                                            <div class="input-group pull-right">
                                                <div class="input-group-btn dropdown" data-dropdown=""
                                                     style="width: 50px">
                                                    <button type="button" name="data" class="form-control novo"
                                                            id="dropdown-appended" value="venda_new" style="width:100%">
                                                        <span class="fa fa-plus-square"></span> Nova Venda
                                                    </button>
                                                </div>
                                                <div class="input-group-btn dropdown" data-dropdown=""
                                                     style="width: 50px">

                                                    <button type="button" name="data" class="form-control"
                                                            id="dropdown-appended" value="venda_new" style="width:100%">
