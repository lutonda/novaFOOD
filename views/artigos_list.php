							...
							<div class="panel panel-primary pop-up ">
									<div class="panel-heading">
										...
										<fieldset class="panel panel-default">
											<div class="col col-md-4"><h3 class="nome">Nome:<br> </h3></div>
										...
										<div class="btn-group navbar-right" role="group" aria-label="...">
                  										...
                  										<div class="input-group col col-md-12 serch_box ">
																			<span class="input-group-addon btn btn-primary" style="padding:0 !important;">
																				<span type="button" class="btn btn-primary novo" value="artigo_new" style="width:100%">
 ...
 while($dado = $query->fetch(PDO::FETCH_OBJ)){
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <button type="submit" class="btn btn-default btn-ls invoice_view" value="artigo_view?'.$dado->codigo.'"><span class="fa fa-file-text-o "></span></span></button>
											<button type="submit" class="btn btn-default btn-ls add" att="addstock" value="'.$dado->id.'">
